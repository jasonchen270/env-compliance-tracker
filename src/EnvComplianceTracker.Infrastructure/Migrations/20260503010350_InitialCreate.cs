        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pollutant = table.Column<string>(type: "TEXT", nullable: false),
                    QuantityTonsCO2e = table.Column<decimal>(type: "TEXT", precision: 18, scale: 3, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmissionsRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmissionsRecords_Facilities_FacilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WasteRecords_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmissionsRecords_FacilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WasteRecords_FacilityId",
                table: "WasteRecords",
                column: "FacilityId");
        }
